...
export const configurableSchemas: ConfigurableSchemas = {
  formSchema: [
    ...
    {
      fieldName: "statusPollIntervalMs",
      type: "number",
      required: false,
    ...
    },
    {
      ...
      type: "array",
      required: false,
      label: "Amenities (Bookable Items)",
      item: {
        type: "object",
        fields: [
          { fieldName: "id", type: "string", required: true, label: "ID" },
