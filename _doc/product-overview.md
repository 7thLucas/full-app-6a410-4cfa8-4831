...
- **Stylized-luxe 3D, not photoreal (built).** The hotel is an explorable 3D world guests
  move through and request from — charming premium render over realism, kept lean enough to
  load instantly in the browser. The four roles and request loop are preserved inside it.
